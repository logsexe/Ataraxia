...
- Native time accounting does not trust DOM-based post counts. Website changes or malicious page scripts can evade cosmetic rules/post counting, but not directly reset the native time counters.
