...
for token in ["ABOUT 4,000 WEEKS","roughly 4,174 weeks","Ataraxia (ἀταραξία) is the ancient Greek idea of a calm, untroubled mind","ATTENTION","INTENTION","MODERATION","AGENCY","Begin in Focused mode","Begin in Balanced mode","Ataraxia is free and has no developer ads or analytics."]:
