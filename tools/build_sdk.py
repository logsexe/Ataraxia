...
run(bt/'aapt2','link','-o',build/'unsigned.apk','-I',android,'--manifest',build/'AndroidManifest.xml','--min-sdk-version','30','--target-sdk-version','35','--version-code','13','--version-name','0.2.0-alpha03','-A',root/'app/src/main/assets',build/'resources.zip')
