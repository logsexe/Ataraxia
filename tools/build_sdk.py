...
run(bt/'aapt2','link','-o',build/'unsigned.apk','-I',android,'--manifest',build/'AndroidManifest.xml','--min-sdk-version','30','--target-sdk-version','35','--version-code','10','--version-name','0.1.9-preview','-A',root/'app/src/main/assets',build/'resources.zip')
